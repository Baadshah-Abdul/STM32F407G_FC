...
typedef struct
{
	__vo uint32_t USART_SR;         /*!< 0x00,Status register     										Address offset: 0x00 */
	__vo uint32_t USART_DR;         /*!< 0x04, Data register     										Address offset: 0x04 */
	__vo uint32_t USART_BRR;        /*!< 0x08,Baud rate register     										Address offset: 0x08 */
	__vo uint32_t USART_CR1;        /*!< 0x0C, Control register 1    										Address offset: 0x0C */
	__vo uint32_t USART_CR2;        /*!< 0x10, Control register 2     										Address offset: 0x10 */
	__vo uint32_t USART_CR3;        /*!< 0x14, Control register 3    										Address offset: 0x14 */
	__vo uint32_t USART_GTPR;       /*!< 0x18, Guard time and pre-scaler register    										Address offset: 0x18 */
} USART_RegDef_t;
...
// Macros to reset USARTx periperals
