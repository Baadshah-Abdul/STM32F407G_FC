...
int main()
{
    ...
    *pCPACR |= 0xF00000;
    ...
    if(whoami == 0x70) printf("Communication success!!. 0x%x\n", whoami);		//%x for hex
    ...
    //pid struct
    PID_Config_t pidPitch = { .Kp = 1.0f, .Ki = 0.00f, .Kd = 0.01f, .output_limit = 400.0f };
    PID_Config_t pidRoll  = { .Kp = 1.0f, .Ki = 0.00f, .Kd = 0.01f, .output_limit = 400.0f };
